...
if  __name__ == "__main__":
    ...
    frame_rate = subprocess.chck_output(f"ffprobe -v error -select_streams v:0 -show_entries stream=r_frame_rate -of csv=s=x:p=0 /home/trif/works/foot_contact_learning/data/{video_name}.mp4", shell=True)
