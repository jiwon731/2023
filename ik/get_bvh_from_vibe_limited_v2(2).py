...
if __name__ == "__main__":
    ...
    with open("/home/user/movingcam/ik/res.pk", "rb") as f:   
    ...
    pydart.init()
    world = pydart.World(1./30., '/home/user/movingcam/data/skel/human_mass_limited_dof_v2.skel')
    ...
    motion.save('/home/user/movingcam/ik/hybrik_postpost.skmo')
