...
class DartSkelMotion(object):
    ...
    def reset_root_trajectory_postpost41(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
    ...
    def reset_root_trajectory_postpost25(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
        ...
        for frame in range(frame_num):
            self.qs[frame][0] = 0.
            self.qs[frame][1] = -1.5
            self.qs[frame][2] = 0.23
            self.qs[frame][3] = 0.
            self.qs[frame][4] = 0.25
            self.qs[frame][5] = 0.
            
            
    def reset_root_trajectory_postpost01(self, skel):
        # print("reset root trajectory!!")
        frame_num = len(self.qs)
