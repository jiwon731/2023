...
from control.postpost25.postpost25_env import SkateDartEnv
...
class PPO(object):
    ...
    def GenerateTransitions(self, skip_frames=[]):
        ...
        while True:
            ...
            for j in range(self.num_slaves):
                ...
                ### skip
                if local_step not in skip_frames:
...
if __name__ == "__main__":
    ...
    for _i in range(500000):
        ###skip_frame
        ppo.GenerateTransitions(skip_frames=[36, 37, 39, 73])
        ppo.Train()
        # print('# {}'.format(i+1))
