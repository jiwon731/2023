...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.box_height = 0.508
        self.box_size = [1.2, self.box_height, 0.2]

        self.world.skeletons[0].add_box("box", self.box_size, [1.0, 1.0, 1.0])
        ...
        # self.height_hat_list = [0.508, 0.]
        #
        # self.box_size = []
        # self.box_size.append([1.524, self.height_hat_list[0], 0.8636])
        # self.box_size.append([0.1, self.height_hat_list[1], 36.88])
        #
        # self.box0_size = self.box_size[0]
        # self.box1_size = self.box_size[1]
        #
        # # add box([name], [size], [color])
        # self.world.skeletons[0].add_box("box0", self.box0_size, [1.0, 1.0, 1.0])
        # self.world.skeletons[0].add_box("box1", self.box1_size, [0., 0., 0.])
        #
        #
        # self.box_pos = []
        # self.box_pos.append(np.array([0., 0.5 * self.box0_size[0], 0.]))
        # self.box_pos.append(np.array([0., 0.5 * self.box1_size[1], 3.0]))
