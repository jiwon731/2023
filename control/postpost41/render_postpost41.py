...
import torch
from control.postpost41.postpost41_ppo_mp import PPO
...
def main():
    ...
    if not MOTION_ONLY:
        ...
        ppo.LoadModel('/home/user/movingcam/control/postpost41/postpost41_model_202311061456/' + 'max.pt')
    ...
    # for bvh file
    bvh_qs = []
    #bvh_file_name = 'ppo_postpost41_vibe.bvh'
    #skmo_file_name = 'ppo_postpost41_vibe.skmo'
    ...
    def simulateCallback(frame):
        ...
        if frame%10 == 0 or 100 > frame > 75:
            ...
            # on mound
            left_bicep_size.append(currentSkelState[19][3])
            left_bicep_T.append(currentSkelState[19][2])

            left_forearm_size.append(currentSkelState[20][3])
            left_forearm_T.append(currentSkelState[20][2])
            
            left_hand_size.append(currentSkelState[21][3])
            left_hand_T.append(currentSkelState[21][2])
