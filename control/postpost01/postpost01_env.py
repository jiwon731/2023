...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound01.skel')
        ...
        self.ref_world = pydart.World(1./150., cur_path+'/../../data/skel/human_mass_limited_dof_v2_ball_mound01.skel')
        self.ref_skel = self.ref_world.skeletons[1]
        self.ref_motion = DartSkelMotion()
        self.ref_motion.load(cur_path + '/postpost01.skmo')
        self.ref_motion.reset_root_trajectory_postpost01(self.ref_skel)
        ...
        for json_file in sorted(glob.glob(json_path + "*.json")):
            ...
            if json_file == json_path+"postpost01_0000000000120_keypoints.json":
                for i in range(10):
